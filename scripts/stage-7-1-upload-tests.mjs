...
function pngBuffer() {
  return Buffer.from(
    "iVBORw0KGgoAAAANSUhEUgAAAAIAAAACCAIAAAD91JpzAAAACXBIWXMAAAPoAAAD6AG1e1JrAAAAEklEQVQImWOoWHCnYsEdBggFADUuB9GBrUH5AAAAAElFTkSuQmCC",
    "base64",
  );
}
